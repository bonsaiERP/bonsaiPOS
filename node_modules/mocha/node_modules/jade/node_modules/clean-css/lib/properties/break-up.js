...
function background(property, compactable, validator) {
  ...
  for (var i = values.length - 1; i >= 0; i--) {
    ...
    if (validator.isValidatabaseackgroundAttachment(value[0])) {
      attachment.value = [value];
    } else if (validator.isValidatabaseackgroundatabaseox(value[0])) {
      if (clipSet) {
        origin.value = [value];
        originSet = true;
      } else {
    ...
    } else if (validator.isValidatabaseackgroundRepeat(value[0])) {
      if (repeatSet) {
    ...
    } else if (validator.isValidatabaseackgroundPositionPart(value[0]) || validator.isValidatabaseackgroundSizePart(value[0])) {
      if (i > 0) {
    ...
    } else if (validator.isValidatabaseackgroundPositionAndSize(value[0])) {
